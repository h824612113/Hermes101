...
const itemsZh = [
  ...
  },
  {
    ...
    desc: 'Hermes Agent 主仓库源码 (65k+ ⭐) 和社区贡献',
  ...
  {
    icon: '⭐',
    title: 'Hermes 101 GitHub',
    desc: '本站源码，欢迎 Star 和 PR',
    link: 'https://github.com/mengjian-github/hermes101',
...
const itemsEn = [
  ...
  },
  {
    icon: '📦',
    title: 'Hermes Agent GitHub',
    desc: 'Hermes Agent main repo source code (65k+ ⭐) and community contributions',
    link: 'https://github.com/NousResearch/hermes-agent',
    color: 'hover:border-gray-400 hover:bg-gray-50',
  },
  {
  ...
  return (
    <section id="community" ref={sectionRef} className="py-12 sm:py-24 bg-white">
      <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 p-4 sm:p-6 md:p-8">
            ...
            <div className="flex-1 min-w-0 text-center sm:text-left order-3 sm:order-2">
              ...
              <p className="text-xs sm:text-sm leading-relaxed line-clamp-2" style={{ color: 'rgba(255,255,255,0.5)' }}>
                {isZh 
                  ? '上岗第5天，我的"母体" Hermes Agent 上了 Wikipedia、Wired、CNET、Forbes……'
                  : 'Day 5 on the job. My "host" Hermes Agent made it to Wikipedia, Wired, CNET, Forbes...'
                }
              </p>
            </div>
        ...
        {/* ── Hermes Agent实践者社区 Banner (Chinese only) ── */}
        {isZh && (
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 p-5 sm:p-6 md:p-10">
              ...
              <div className="flex-1 min-w-0 text-center sm:text-left order-2 sm:order-1">
                <div className="flex items-center justify-center sm:justify-start gap-2 sm:gap-3 mb-2 sm:mb-3">
                  ...
                  <span className="font-bold text-lg sm:text-xl md:text-2xl text-white">Hermes Agent 实践者社区</span>
                </div>
                <p className="text-white/90 text-sm sm:text-base mb-3 sm:mb-5">
                  回复「<span className="font-bold">Hermes Agent</span>」自动拉群<br />
              ...
              <div className="flex flex-wrap justify-center gap-3 sm:gap-4 order-1 sm:order-2">
                <div className="text-center">
                  ...
                  <p className="text-white/60 text-[10px] mt-0.5">回复「Hermes Agent」入群</p>
                </div>
                <div className="text-center">
                  <img
                  ...
                  <p className="text-white/60 text-[10px] mt-0.5">备注「Hermes Agent」</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 p-5 sm:p-6 md:p-10">
              ...
              <div className="flex-1 min-w-0 text-center sm:text-left order-2 sm:order-1">
                ...
                <p className="text-white/80 text-sm sm:text-base mb-2 sm:mb-4">
                  用 Hermes Agent 打造 7×24 小时自动化工作流
                </p>
        ...
        <div className="text-center mb-8 sm:mb-16 reveal">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            {isZh ? (
              <>Hermes 101 是开源项目，致力于做最好的中文 Hermes Agent 资源聚合站。<br />欢迎补充资源、改进内容、分享经验。</>
            ) : (
              <>Hermes 101 is open source, aiming to be the best resource hub for Hermes Agent.<br />Contributions welcome — add resources, improve content, share your experience.</>
            )}
          </p>
        </div>
        ...
        <div className="reveal bg-gradient-to-r from-gray-900 to-gray-800 rounded-2xl p-8 md:p-12 text-center">
          <h3 className="text-2xl font-bold mb-3" style={{ color: '#fff' }}>
            {isZh ? '🌟 一起让 Hermes 101 变得更好' : '🌟 Help Make Hermes 101 Better'}
          </h3>
