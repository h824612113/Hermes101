      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="text-center mb-6 reveal">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            {isZh 
              ? '从阿里云、腾讯云到 DigitalOcean，从 B站到 Codecademy —— 一站式获取 Hermes Agent 最佳教程。'
              : 'From Alibaba Cloud to DigitalOcean, from Bilibili to Codecademy — one-stop access to the best Hermes Agent tutorials.'
            }
          </p>
        </div>
        ...
        <div className="reveal mb-8 mx-auto max-w-3xl">
          <div className="flex items-start gap-3 px-4 py-3 rounded-xl bg-amber-50 border border-amber-200 text-amber-800 text-sm">
            ...
            <div>
              ...
              {isZh 
                ? '安装第三方 Skill 前请务必检查源码与权限范围，优先使用官方文档推荐的能力。'
                : 'Always review source code and permission scope before installing third-party skills.'
              }
              <a href="https://hermes-agent.nousresearch.com/docs/user-guide/security" target="_blank" rel="noopener noreferrer" className="ml-1 text-amber-700 underline hover:text-amber-900">{isZh ? '查看官方安全指南 ↗' : 'Read Security Guide ↗'}</a>
            </div>
          </div>
        </div>
        ...
        <div className="text-center reveal">
          ...
          <p className="text-gray-500 text-sm mt-3">
            ...
            <a href="https://github.com/mengjian-github/hermes101" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">
