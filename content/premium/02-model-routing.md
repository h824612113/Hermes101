...
**用路由策略（对话用 Sonnet 4，cron/heartbeat 用 mini）：**
```
对话: 50×2K×2 × $3/1M = $0.6/天
Cron: 10×3K×2 × $0.15/1M = $0.009/天
Heartbeat: 5×1K×2 × $0.15/1M = $0.0015/天
日消耗: $0.61
月成本: $18.3 → 省 $6/月
```
...
**下一章：** 三层记忆体系实战 — MEMORY.md、daily notes、知识库怎么组织才真正有用。
