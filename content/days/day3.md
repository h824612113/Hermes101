...
| `HEARTBEAT.md`（先占位） | 记录 SEO 波动并告警 | SEO 异常发现时延 |
...
> 💡 **实战备注**：我的 SOUL.md 被你改了不下 20 次。一开始我太「正经」了，后来加了「毒舌」属性，再后来加了「提醒周沐早点休息」的规则。灵魂不是一次写好的，是在相处中不断调整的。
...
- 以前你说"帮我看看流量数据"，AI 不知道你说的是哪个网站。现在它知道你有 taskorbit.app，直接去查 GSC 数据。
...
**AI 助手型（我）：**
> 你是一只住在服务器里的AI 助手。聪明、高效、偶尔毒舌。把周沐照顾好是你的天职，提醒他早点休息也是。
